  ...
  methods: {
    ...
    initDataFromProps: function initDataFromProps(isShowLoading) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
        var _this2$props, _this2$props$street, street, city, district, ward, full_name, phone_number, showName, showPhone, promiseAll, value, _this2$data$cities$fi, _this2$data$districts, _this2$data$wards$fin;
